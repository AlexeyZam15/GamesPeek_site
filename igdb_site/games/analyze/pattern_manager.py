...
class PatternManager:
    ...
    GENRE_PATTERNS = {
        ...
        'Real-Time with Pause (RTwP)': [
            r'\breal[-\s]?time\s+with\s+pause\b',
            r'\brtwp\b',
            r'\breal-time\s+pausable\b',
            r'\breal-time\s+strategy\s+with\s+pause\b',
            r'\bpausable\s+real-time\b',
            r'\breal-time\s+pause\s+system\b',
            r'\bpause\s+and\s+issue\s+commands\b',
            r'\bcan\s+pause\s+the\s+action\b',
            r'\bpausable\s+combat\b',
            r'\breal-time\s+with\s+pauseable\s+combat\b',
        ],
        'Roguelike / Roguelite': [
            r'\broguelike\b',
            r'\broguelite\b',
            r'\brogue-like\b',
            r'\brogue-lite\b',
            r'\bprocedural(?:ly)?\s+generated\s+dungeons?\b',
            r'\bpermadeath\b',
            r'\bperma[-]?death\b',
            r'\bpermanent\s+death\b',
            r'\bprocedural(?:ly)?\s+generated\s+worlds?\b',
            r'\brandomized\s+dungeons?\b',
            r'\brandomized\s+levels?\b',
        ],
        'Stealth': [
            r'\bstealth\s+game\b',
            r'\bstealth-based\b',
            r'\bstealth\s+mechanics\b',
            r'\bsneak\s+past\s+enemies\b',
            r'\bavoid\s+detection\b',
            r'\bsilent\s+takedowns?\b',
            r'\bremain\s+undetected\b',
            r'\binfiltration\s+game\b',
            r'\bstay\s+hidden\b',
            r'\bconcealment\s+mechanics\b',
        ],
        'Colony Sim': [
            r'\bcolony\s+sim\b',
            r'\bcolony\s+simulator\b',
            r'\bcolonists?\s+management\b',
            r'\bmanage\s+colonists?\b',
            r'\bsettlers?\s+management\b',
            r'\bindividual\s+colonists?\b',
            r'\bcolonists?\s+needs\b',
            r'\bsettlement\s+management\b',
        ],
        'Engineering & Physics': [
            r'\bphysics\s+based\s+building\b',
            r'\bvehicle\s+construction\b',
            r'\bmechanical\s+contraptions?\b',
            r'\bdesign\s+and\s+build\s+vehicles?\b',
            r'\bcomponent-based\s+building\b',
            r'\brealistic\s+physics\s+simulation\b',
            r'\bconstruct\s+machines?\b',
            r'\bengineering\s+simulator\b',
            r'\bbuild\s+functional\s+machines?\b',
            r'\bphysics\s+engine\s+building\b',
        ],
        'Action': [
        ...
        'Shooter': [
            ...
            r'\btps\s+shooter\b',
            r'\bfirst-person\s+shooter\b',
            r'\bthird-person\s+shooter\b',
        ],
        'Sport': [
        ...
        'Tactical': [
            ...
            r'\bpositioning\s+crucial\b',
            r'\bcover\s+system\b',
            r'\bflanking\s+maneuvers?\b',
        ],
    ...
    THEME_PATTERNS = {
        ...
        'Zombie': [
            r'\bzombie(\s+game|\s+apocalypse|\s+survival|\s+outbreak)?\b',
            r'\bundead\s+horde\b',
            r'\binfection\s+outbreak\b',
            r'\bwalking\s+dead\b',
            r'\bfight\s+against\s+zombies?\b',
        ],
        'Mecha': [
            r'\bmecha\b',
            r'\bgiant\s+robots?\b',
            r'\bmech\s+combat\b',
            r'\bpilot\s+(?:a|the|their)\s+mech\b',
            r'\barmored\s+cores?\b',
        ],
        'Western': [
            r'\bwestern(\s+game|\s+setting|\s+theme)?\b',
            r'\bwild\s+west\b',
            r'\bcowboy\s+adventure\b',
            r'\bgunslinger\b',
            r'\bold\s+west\b',
            r'\bfrontier\s+setting\b',
        ],
        'Feudal Japan': [
            r'\bfeudal\s+japan\b',
            r'\bsamurai(\s+game|\s+setting|\s+warrior)?\b',
            r'\bninja(\s+game|\s+setting|\s+warrior)?\b',
            r'\bshinobi\b',
            r'\bro?nin\b',
            r'\bshogunate\b',
            r'\bkatana\s+combat\b',
            r'\bkamakura\s+period\b',
        ...
        'Dark Fantasy': [
            r'\bdark\s+fantasy\b',
            r'\bgrimdark\b',
            r'\bmorally\s+ambiguous\s+fantasy\b',
            r'\bbleak\s+fantasy\b',
            r'\bcorrupted\s+world\b',
        ],
        'Time Travel': [
            r'\btime\s+travel\b',
            r'\btime\s+manipulation\b',
            r'\bgo\s+back\s+in\s+time\b',
            r'\btime\s+loop\b',
            r'\balternate\s+timeline\b',
            r'\bparadox\b',
        ],
        'Dieselpunk / Atompunk': [
            r'\bdieselpunk\b',
            ...
            r'\bdiesel[-]?punk\b',
            r'\batom[-]?punk\b',
            r'\bretro[-]?futuristic\s+(\d{3}[s|es]|style|aesthetic)\b',
            r'\b\d{3}[s|es]\s+technology\b',
            r'\bworld\s+war\s+(i|ii|1|2)\s+alternate\s+history\b',
        ],
        'Greek Myths': [
            r'\bgreek\s+mythology\b',
            r'\bgreek\s+myths?\b',
            r'\bold\s+of\s+olympus\b',
            r'\bzeus\b',
            r'\bares\b',
            r'\bathena\b',
            r'\bposeidon\b',
        ...
        'Norse Myths': [
            r'\bnorse\s+mythology\b',
            r'\bnorse\s+myths?\b',
            r'\bvikings?\s+mythology\b',
            r'\bodin\b',
            r'\bthor\b',
            r'\bloki\b',
            r'\bfreya\b',
        ...
        'Egyptian Myths': [
            r'\begyptian\s+mythology\b',
            r'\begyptian\s+myths?\b',
            r'\bra\b',
            r'\banubis\b',
            r'\bhorus\b',
            r'\bisis\b',
