...
class PatternManager:
    ...
    GENRE_PATTERNS = {
        ...
        'Engineering & Physics': [
            ...
            r'\bphysics\s+sim(?:ulation)?\b',
            r'\bphysics-based\b',
            r'\brealistic\s+physics\b',
            r'\bmechanical\s+simulation\b',
            r'\bvehicle\s+engineering\b',
            r'\bphysics\s+engine\b',
        ...
        'Survival': [
            ...
            r'\b(?:hunger|thirst|stamina|health|temperature)\s+(?:system|mechanics?|management)\b',
    ...
    THEME_PATTERNS = {
        ...
        'Western': [
            ...
            r'\bfrontier\s+town\b',
            r'\bsaloon\b',
            r'\bsheriff\b',
            r'\boutlaw\b',
            r'\bposse\b',
            r'\bhorseback\s+riding\b',
            r'\bstagecoach\b',
            r'\brevolver\s+duel\b',
            r'\bdesperado\b',
            r'\brange\s+rider\b',
            r'\bprairie\s+setting\b',
            r'\bgunslinger\b',
            r'\blasso\b',
            r'\bwagon\s+train\b',
            r'\bgold\s+rush\b',
        ...
        'Zombie': [
            ...
            r'\bzombie\s+apocalypse\b',
            r'\boutbreak\s+of\s+zombies\b',
        ],
    }
