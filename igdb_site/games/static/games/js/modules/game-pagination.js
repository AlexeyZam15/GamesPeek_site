...
const GamePagination = {
    ...
    config: {
        ...
        paginationSelector: '#games-pagination',
        prevButtonId: '#games-prev',
        nextButtonId: '#games-next',
        startElementId: '#games-start',
        endElementId: '#games-end',
        currentElementId: '#games-current',
        totalElementId: '#games-total',
    ...
    createPageNumbersContainer() {
        ...
        pageNumbersContainer.id = 'games-page-numbers';
    ...
    updatePageNumbers() {
        const pageNumbersContainer = document.getElementById('games-page-numbers');
    ...
    forceUpdate() {
        ...
        if (this.totalItems <= this.config.itemsPerPage) {
            ...
            if (!document.getElementById('games-page-numbers')) {
                this.createPageNumbersContainer();
            }
